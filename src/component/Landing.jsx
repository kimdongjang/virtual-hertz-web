  ...
  return (
    <div>
      ...
      <div>
        <header className="bg-gray-800" x-data="{ isOpen: false }">
          <nav className="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
            <div className="flex items-center justify-between">
              ...
              <div click="isOpen = !isOpen" className="flex md:hidden">
        ...
        <section className="bg-white">
          <div className="max-w-5xl px-6 py-16 mx-auto">
            <h2 className="text-3xl font-semibold text-gray-800">Lorem ipsum dolor sit amet, consectetur adipiscing</h2>
        ...
        <section className="bg-white">
          <div className="max-w-5xl px-6 py-16 mx-auto">
            <div className="md:flex md:justify-between">
              <h2 className="text-3xl font-semibold text-gray-800">Lorem ipsum dolor sit amet, consectetur adipiscing
